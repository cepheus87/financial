...
class CalculateIncome:
    ...
    def calculate_income_costs(self, entity_symbol: str | None = None) -> Tuple[Dict[str, List], Dict[str, List]]:
        """
...
def main(statement_paths: List[str], entity_symbol: str = None):

    calculator = CalculateIncome(statement_paths)
    income, costs = calculator.calculate_income_costs(entity_symbol)
